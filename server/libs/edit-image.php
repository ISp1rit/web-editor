...
switch ($data['command']) {
  ...
  // case 'COLORIZE':
  //   editImage($data, $currentImageDirectory, $editImagesDirectory, 'filterColorize');
  //   break;
  ...
  // case 'DARKEN':
  //   editImage($data, $currentImageDirectory, $editImagesDirectory, 'filterDarken');
  //   break;
  //
  // case 'DUOTONE':
  //   editImage($data, $currentImageDirectory, $editImagesDirectory, 'filterDuotone');
  //   break;
  //
  // case 'EDGE_DETECT':
  //   editImage($data, $currentImageDirectory, $editImagesDirectory, 'filterEdgeDetect');
  //   break;
  //
  // case 'EMBOSS':
  //   editImage($data, $currentImageDirectory, $editImagesDirectory, 'filterEmboss');
  //   break;
  //
  ...
  // case 'OPACITY':
  //   editImage($data, $currentImageDirectory, $tempImagesDirectory, $editImagesDirectory, 'filterOpacity');
  //   break;

  // case 'PIXELATE':
  //   editImage($data, $currentImageDirectory, $editImagesDirectory, 'filterPixelate');
  //   break;
  //
  case 'SEPIA':
  ...
  // case 'SHARPEN':
  //   editImage($data, $currentImageDirectory, $tempImagesDirectory, $editImagesDirectory, 'filterSharpen');
  //   break;

  // case 'SKETCH':
  //   editImage($data, $currentImageDirectory, $editImagesDirectory, 'filterSketch');
  //   break;
...
// function filterColorize($data, $currentImageDirectory, $tempImagesDirectory, $editImagesDirectory, $fileName, $newFileName)
// {
//   try {
//     $image = new \claviska\SimpleImage();
//     $image
...
// function filterOpacity($data, $currentImageDirectory, $tempImagesDirectory, $editImagesDirectory, $fileName, $newFileName)
// {
//   try {
//     $image = new \claviska\SimpleImage();
//     $image
